...
Kies in de vragenlijst het van toepassing zijnde antwoord en vul de open vragen in.', 10),
  ...
  (@form_id, 'kenniscafes', 'Kenniscafés, speeddates en bijeenkomsten', 'Vanuit Digikrachtig Rivierenland organiseren wij kenniscafés, speeddates en bijeenkomsten voor bedrijven en hun medewerkers. Waar is vanuit uw bedrijf interesse in?', 120),
  (@form_id, 'afsluiting', '', 'Hulp nodig met digitale vraagstukken?

Ga naar www.digikrachtig.nl en stel uw vraag bij ‘Stel je vraag’ of mail naar digikrachtig@rocrivor.nl

Hartelijk dank voor het invullen van de vragenlijst!', 130);
...
VALUES
  ...
  ('m365', 'm365_melding', 'Vul onderstaande vragen over Word, Excel, PowerPoint, Outlook, Teams en OneDrive in.', NULL, 'melding', NULL, 0, 30, 'm365_gebruik', 'ja, Microsoft 365|ja, Microsoft Office'),
  ...
  ('word', 'word_toelichting', 'Geef hier een korte toelichting op:', NULL, 'tekstvak', NULL, 0, 60, 'word_gebruik', 'ja'),
  ...
  ('excel', 'excel_toelichting', 'Geef hier een korte toelichting op:', NULL, 'tekstvak', NULL, 0, 60, 'excel_gebruik', 'ja'),
  ...
  ('powerpoint', 'powerpoint_toelichting', 'Geef hier een korte toelichting op:', NULL, 'tekstvak', NULL, 0, 60, 'powerpoint_gebruik', 'ja'),
  ...
  ('outlook', 'outlook_toelichting', 'Geef hier een korte toelichting op:', NULL, 'tekstvak', NULL, 0, 60, 'outlook_gebruik', 'ja'),
  ...
  ('teams', 'teams_toelichting', 'Geef hier een korte toelichting op:', NULL, 'tekstvak', NULL, 0, 60, 'teams_gebruik', 'ja'),
  ...
  ('onedrive', 'onedrive_toelichting', 'Geef hier een korte toelichting op:', NULL, 'tekstvak', NULL, 0, 60, 'onedrive_gebruik', 'ja'),
  ...
  ('website', 'website_hulp', 'Wilt u hierbij hulp en advies van studenten?', NULL, 'radio', '["ja","nee"]', 1, 30, 'website_interesse', 'ja'),
  ('website', 'website_melding_hulp', 'Wij nemen contact met u op om uw wensen en de mogelijkheden te bespreken.', NULL, 'melding', NULL, 0, 40, 'website_hulp', 'ja'),
  ('website', 'website_melding_heeft', 'Als uw bedrijf een website heeft:', NULL, 'melding', NULL, 0, 50, 'website_heeft', 'ja'),
  ('website', 'website_doel', 'Wat is het doel van de website (bijv. informatie geven, webshop)?', NULL, 'tekstvak', NULL, 0, 60, 'website_heeft', 'ja'),
  ('website', 'website_beheer', 'Onderhoudt u de website zelf of is dit uitbesteed?', NULL, 'radio', '["zelf","uitbesteed"]', 1, 70, 'website_heeft', 'ja'),
  ('website', 'website_tevreden', 'Bent u tevreden over uw website?', NULL, 'radio', '["ja","nee"]', 1, 80, 'website_heeft', 'ja'),
  ('website', 'website_verbeteringen', 'Welke verbeteringen of ondersteuning zijn gewenst m.b.t. uw website?', NULL, 'tekstvak', NULL, 0, 90, 'website_tevreden', 'nee'),
  ('website', 'website_scan', 'Heeft u interesse in een scan van uw website door studenten waarbij zij u een advies geven over mogelijke verbeteringen?', NULL, 'radio', '["ja","nee"]', 1, 100, 'website_heeft', 'ja'),
  ('website', 'website_melding_scan', 'Wij nemen contact met u op om dit met u af te stemmen.', NULL, 'melding', NULL, 0, 110, 'website_scan', 'ja'),
  ...
  ('social_media', 'social_hulp', 'Wilt u hierbij hulp en advies van studenten?', NULL, 'radio', '["ja","nee"]', 1, 30, 'social_interesse', 'ja'),
  ('social_media', 'social_melding_hulp', 'Wij nemen contact met u op om uw wensen en de mogelijkheden te bespreken.', NULL, 'melding', NULL, 0, 40, 'social_hulp', 'ja'),
  ('social_media', 'social_melding_actief', 'Als u al actief bent op social media:', NULL, 'melding', NULL, 0, 50, 'social_actief', 'ja'),
  ('social_media', 'social_platforms', 'Welk(e) platform(s) gebruikt uw bedrijf?', NULL, 'tekst', NULL, 0, 60, 'social_actief', 'ja'),
  ('social_media', 'social_doel', 'Wat is het doel van de social media (bijv. informatie geven, reclame)?', NULL, 'tekstvak', NULL, 0, 70, 'social_actief', 'ja'),
  ('social_media', 'social_posts', 'Wat post uw bedrijf op social media?', NULL, 'tekstvak', NULL, 0, 80, 'social_actief', 'ja'),
  ('social_media', 'social_beheer', 'Onderhoudt u de social media zelf of is dit uitbesteed?', NULL, 'radio', '["zelf","uitbesteed"]', 1, 90, 'social_actief', 'ja'),
  ('social_media', 'social_tevreden', 'Bent u tevreden over het gebruik van social media voor uw bedrijf?', NULL, 'radio', '["ja","nee"]', 1, 100, 'social_actief', 'ja'),
  ('social_media', 'social_hulp_verbetering', 'Wilt u hulp en advies van studenten m.b.t. uw social media?', NULL, 'radio', '["ja","nee"]', 1, 110, 'social_tevreden', 'nee'),
  ('social_media', 'social_melding_verbetering', 'Wij nemen contact met u op om uw wensen en de mogelijkheden te bespreken.', NULL, 'melding', NULL, 0, 120, 'social_hulp_verbetering', 'ja'),
...
SELECT
  ...
  (SELECT COUNT(*) FROM questions WHERE form_id = @form_id) AS rijen,
  (SELECT COUNT(*) FROM questions WHERE form_id = @form_id
     AND type = 'melding')                                   AS meldingen,
  (SELECT COUNT(*) FROM questions WHERE form_id = @form_id
